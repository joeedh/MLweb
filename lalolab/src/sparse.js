 ...
 * @struct
 */
export class spVector {
  constructor(n, values, indexes) {
 ...
 * @struct
 */
export class spMatrix {
  constructor(m, n, values, cols, rows) {
...
export function spgetRows(A, rowsrange) {
 ...
 * @return{spVector}
 */
export function sparseVector(a) {
  var i, k;
  const n = a.length;
  var val = new Array();
  var ind = new Array();
 ...
 * @return{spMatrix}
 */
export function sparseMatrix(A) {
  var i, j;
  const m = A.m;
  const n = A.n;
  var val = new Array();
 ...
 * @return{spMatrix}
 */
export function sparseMatrixRowMajor(A) {
  var i, j;
  const m = A.m;
  const n = A.n;
  var val = new Array();
...
export function sparse(A, rowmajor) {
 ...
 * @return{Matrix}
 */
export function transposespVector(a) {
 ...
 * @return{spMatrix}
 */
export function transposespMatrix(A) {
 ...
 * @return {spMatrix}
 */
export function spmat(elems, rowwise) {
  var k;
 ...
 * @return{spVector}
 */
export function mulScalarspVector(a, b) {
 ...
 * @return{spMatrix}
 */
export function mulScalarspMatrix(a, B) {
  const nnz = B.nnz;
  var C = B.copy();
  for (var k = 0; k < nnz; k++) {
    C.val[k] *= a;
 ...
 * @return{number}
 */
export function dotspVectorVector(a, b) {
  const nnza = a.val.length;
  var c = 0;
 ...
 * @return{Float64Array}
 */
export function mulMatrixspVector(A, b) {
  const m = A.m;
  const n = A.n;
  const nnz = b.val.length;
  var c = zeros(m);
 ...
 * @return{Float64Array}
 */
export function mulspMatrixVector(A, b) {
  const m = A.m;
  const n = A.n;
  var c = zeros(m);
  if (A.rowmajor) {
 ...
 * @return{Float64Array}
 */
export function mulspMatrixTransVector(A, b) {
  const m = A.m;
  const n = A.n;
  var c = zeros(n);
  if (A.rowmajor) {
 ...
 * @return{Float64Array}
 */
export function mulspMatrixspVector(A, b) {
  const m = A.m;
  const n = A.n;
  var c = zeros(m);
  const nnzb = b.val.length;
 ...
 * @return{Float64Array}
 */
export function mulspMatrixTransspVector(A, b) {
  const m = A.m;
  const n = A.n;
  var c = zeros(n);
  const nnzb = b.val.length;
 ...
 * @return{Matrix}
 */
export function mulspMatrixspMatrix(A, B) {
  const m = A.m;
  const n = A.n;
  const n2 = B.n;
  var c = zeros(m, n2);
 ...
 * @return{Matrix}
 */
export function mulMatrixspMatrix(A, B) {
  const m = A.m;
  const n = A.n;
  const n2 = B.n;
  var c = zeros(m, n2);
 ...
 * @return{Matrix}
 */
export function mulspMatrixMatrix(A, B) {
  const m = A.m;
  const n = A.n;
  const n2 = B.n;
  var c = zeros(m, n2);
 ...
 * @return{spVector}
 */
export function entrywisemulspVectors(a, b) {
  const nnza = a.val.length;
  const nnzb = b.val.length;
  var val = new Array();
  var ind = new Array();
 ...
 * @return{spVector}
 */
export function entrywisemulspVectorVector(a, b) {
 ...
 * @return{spMatrix}
 */
export function entrywisemulspMatrices(A, B) {
  if (A.rowmajor) {
    if (B.rowmajor) {
      var val = new Array();
      var cols = new Array();
 ...
 * @return{spMatrix}
 */
export function entrywisemulspMatrixMatrix(A, B) {
  var c = A.copy();
  const nnz = A.val.length;
  const n = A.n;
  const m = A.m;
 ...
 * @return{Float64Array}
 */
export function addScalarspVector(a, b) {
  const nnzb = b.val.length;
  const n = b.length;
  var c = zeros(n);
  var k;
 ...
 * @return{Float64Array}
 */
export function addVectorspVector(a, b) {
  const nnzb = b.val.length;
  const n = b.length;
 ...
 * @return{spVector}
 */
export function addspVectors(a, b) {
  const nnza = a.val.length;
  const nnzb = b.val.length;
 ...
 * @return{Matrix}
 */
export function addScalarspMatrix(a, B) {
  const nnzb = B.val.length;
  const m = B.m;
  const n = B.n;
  const mn = m*n;
 ...
 * @return{Matrix}
 */
export function addMatrixspMatrix(A, B) {
  const nnzb = B.val.length;
  const m = B.m;
  const n = B.n;
  const mn = m*n;
 ...
 * @return{spMatrix}
 */
export function addspMatrices(A, B) {
  const nnza = A.val.length;
  const nnzb = B.val.length;
  const m = A.m;
  const n = A.n;
 ...
 * @return{Float64Array}
 */
export function subScalarspVector(a, b) {
  const nnzb = b.val.length;
  const n = b.length;
  var c = zeros(n);
  var k;
 ...
 * @return{Float64Array}
 */
export function subVectorspVector(a, b) {
  const nnzb = b.val.length;
  const n = b.length;
  var c = new Float64Array(a);
  for (var k = 0; k < nnzb; k++) {
 ...
 * @return{Float64Array}
 */
export function subspVectorVector(a, b) {
 ...
 * @return{spVector}
 */
export function subspVectors(a, b) {
  const nnza = a.val.length;
  const nnzb = b.val.length;
  var c = zeros(a.length);
  var k;
 ...
 * @return{Matrix}
 */
export function subScalarspMatrix(a, B) {
  const nnzb = B.val.length;
  const m = B.m;
  const n = B.n;
  const mn = m*n;
 ...
 * @return{Matrix}
 */
export function subspMatrixMatrix(A, B) {
 ...
 * @return{Matrix}
 */
export function subMatrixspMatrix(A, B) {
  const nnzb = B.val.length;
  const m = B.m;
  const n = B.n;
  const mn = m*n;
 ...
 * @return{spMatrix}
 */
export function subspMatrices(A, B) {
  const nnza = A.val.length;
  const nnzb = B.val.length;
  const m = A.m;
  const n = A.n;
 ...
 * @return{Float64Array}
 */
export function applyspVector(f, x) {
  const nnz = x.val.length;
  const n = x.length;
 ...
 * @return{Matrix}
 */
export function applyspMatrix(f, X) {
  const nnz = X.val.length;
  const m = X.m;
  const n = X.n;
  const mn = m*n;
 ...
 * @return{Matrix}
 */
export function sumspMatrixRows(A) {
  var res = zeros(A.n);
  if (A.rowmajor) {
 ...
 * @return{Float64Array}
 */
export function sumspMatrixCols(A) {
  var res = zeros(A.m);
  if (A.rowmajor) {
    for (var i = 0; i < A.m; i++) {
 ...
 * @return{Matrix}
 */
export function prodspMatrixRows(A) {
  if (A.rowmajor) {
    var res = ones(A.n);
    for (var i = 0; i < A.m; i++) {
      var s = A.rows[i];
 ...
 * @return{Float64Array}
 */
export function prodspMatrixCols(A) {
  if (A.rowmajor) {
    var res = zeros(A.m);
    for (var i = 0; i < A.m; i++) {
      var a = A.row(i);
